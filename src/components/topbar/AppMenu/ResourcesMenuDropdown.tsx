        ...
        <Row className="p-2 p-sm-4">
            ...
            <div className="d-md-flex gap-4 h-100">
              <ul className="list-unstyled w-100">
                ...
                {usefulLinks.map((item, idx) => {
                  ...
                  return (
                    <li key={idx}>
                      <DropdownItem as={Link} className="dropdown-item icons-center" to="">
                        <Icon className="me-2" />
                        {item.name}
                      </DropdownItem>
                    </li>
          ...
          <Col md={6} xl={4} xxl={5} className="h-100">
            ...
            {keyFeatures.map((item, idx) => {
              const Icon = item.icon
              return (
                <DropdownItem key={idx} as={'div'} className="bg-light-hover d-flex align-items-center justify-content-between position-relative text-wrap py-3">
                  ...
                  <Link to="" className="icon-link icon-link-hover text-primary-hover stretched-link">
          ...
          <Col lg={4}>
            ...
            <Card className="bg-transparent px-3">
              <img src={featureResource.image} className="rounded mb-3" alt="feature-img" />
              <CardBody className="p-0">
                <h6>
                  <Link to="">{featureResource.title}</Link>
                </h6>
                <p className="mb-2">{featureResource.description}</p>
                <Link to="" className="icon-link icon-link-hover stretched-link z-index-2">
                  Check it out
                  <BsArrowRight />
                </Link>
              </CardBody>
