      ...
      <Container className="position-relative pt-4 pt-lg-0">
        <Row className="align-items-center">
          <Col md={7} xl={6} className="mb-7 mb-md-0">
            ...
            <Link to="/contact/v1" className="btn btn-lg btn-dark mb-5 icons-center"><BsTelephone className="me-2" />Contact us</Link>
            <div className="d-sm-flex align-items-center">
              <ul className="avatar-group mb-0 align-items-center">
                ...
                <li className="avatar avatar-lg">
                  <div className="avatar-img rounded-circle bg-primary"><span className="text-white position-absolute top-50 start-50 translate-middle">10K+</span></div>
                </li>
              </ul>
              <div className="ms-sm-3 mt-2 mt-sm-0">
                <p className="heading-color fw-normal mb-1">More then 10k active users! 🤩</p>
                <Link className="icon-link icon-link-hover text-primary-hover mt-auto" to="">Join them now<BsArrowRight /> </Link>
              </div>
            </div>
          </Col>
