...
import { testimonials } from "@/pages/services/Single/data"
import type { TestimonialType } from "@/pages/services/Single/types"
  ...
  return (
    <>
      ...
      <ul className="list-inline mb-3">
        {rating && Array(Math.floor(rating)).fill(0).map((_star, idx) => (
        ...
        {rating && rating < 5 && Array(5 - Math.ceil(rating)).fill(0).map((_star, idx) => (
          <li key={idx}
...
const Testimonials = () => {
  ...
  return (
    <Col lg={5} className="ms-auto">
      ...
      <p className="lead mb-2">300+ Users rated us <span className="text-primary fw-bold">4.85</span> out of 5.</p>
