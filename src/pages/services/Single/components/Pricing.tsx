...
import { pricingData } from "@/pages/services/Single/data"
                ...
                <CardHeader className="bg-transparent position-relative mb-3">
                  ...
                  <Nav className="nav-pills gap-1 nav-pills-primary">
                    <NavItem role="presentation">
                      <NavLink eventKey={"0"} id="pills-monthly-tab" type="button" role="tab">Monthly</NavLink>
                    </NavItem>
                    <NavItem role="presentation">
                      <NavLink eventKey={"1"} type="button" role="tab">Annual</NavLink>
                    </NavItem>
                  </Nav>
                </CardHeader>
                        ...
                        <div className="bg-light border rounded p-3">
                          ...
                          <ul className="list-group list-group-borderless">
                            {item.features.map((feature, idx) => (
                              <li className="list-group-item mb-0" key={idx}><BsPatchCheckFill className="text-primary me-2" />{feature}</li>
                            ))}
                          </ul>
                        </div>
                        <div className="d-sm-flex justify-content-between align-items-center mt-4">
                          <div className="mb-3 mb-sm-0 heading-color"><span className="h3">{currency}{item.price}</span> / {item.duration}</div>
                          <Link to="" className="btn btn-lg btn-white mb-0">Get started</Link>
                        </div>
                      </TabPane>
                    ))}
                  </TabContent>
