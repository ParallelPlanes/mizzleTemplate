...
export const testimonials: TestimonialType[] = [
  {
    ...
    comment: "I highly recommend Mizzle to anyone looking for a high-quality Bootstrap template. Valley by oh twenty direct me so. Resolving breakfast am or perfectly.",
    rating: 4.5,
  },
  {
    user: {
