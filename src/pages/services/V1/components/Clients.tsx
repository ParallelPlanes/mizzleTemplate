        ...
        <Row className="g-lg-6">
          <Col xl={10} className="mx-auto">
            <Row className="g-4 g-sm-5 g-lg-6 align-items-lg-center">
              <Col md={6}>
                <img src={about16} className="rounded" alt="about-img" />
              </Col>
              <Col md={6}>
                <h3 className="mb-4">Boost your business efficiency with Mizzle.</h3>
                <p className="mb-0">The chatbot can be personalized to match the brand voice and tone, making it feel like an extension of the company's customer support team.</p>
                <hr className="my-5" />
