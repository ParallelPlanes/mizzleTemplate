...
import type { TestimonialType } from "@/pages/about/V2/types"
...
const TestimonialCard = ({ testimonial }: { testimonial: TestimonialType }) => {
  ...
  return (
    <Card className="card-body bg-light p-sm-5">
      <div className="icon-lg bg-primary bg-opacity-10 text-primary rounded flex-centered"><BsQuote className="fa-xl" size={29}/></div>
