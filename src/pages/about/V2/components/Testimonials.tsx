import { testimonials } from '@/pages/about/V2/data'
      ...
      <Container>
        <Row className="g-4 align-items-center">
          <Col xl={4} >
            ...
            <p className="lead mb-2">3000+ Users rated us <span className="text-warning fw-bold">4.85</span> out of 5.</p>
            ...
            <div className="d-flex gap-3 position-relative mt-5 mt-md-6">
              <Link to="" className="btn btn-outline-white btn-icon rounded-circle mb-0 swiper-button-prev"><BsArrowLeft /></Link>
              <Link to="" className="btn btn-outline-white btn-icon rounded-circle mb-0 swiper-button-next"><BsArrowRight /></Link>
            </div>
          </Col>
          <Col xl={8}>
