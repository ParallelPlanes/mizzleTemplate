...
import type { MemberType } from "@/pages/about/V1/types"
  ...
  return (
    <Card className="card-body card-hover-shadow bg-transparent text-center p-4">
      ...
      <ul className="list-inline mb-0 mt-3 flex-centered gap-1">
        ...
        <li className="list-inline-item"> <Link className="btn btn-xs btn-icon btn-light" to=""><FaTwitter className="fa-fw lh-base" /></Link> </li>
      </ul>
    </Card>
  )
}
