      ...
      <Container className="position-relative">
        <div className="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
          <figure className="position-absolute top-0 start-0 mt-n5">
            <svg className="fill-white" style={{ opacity: '0.02' }} width={662} height={614} viewBox="0 0 662 614" xmlns="http://www.w3.org/2000/svg">
          ...
          <figure className="position-absolute top-0 end-0 mt-n5 me-n5">
            <svg className="fill-primary opacity-2" width="220px" height="209px" viewBox="0 0 220 209"  xmlSpace="preserve">
          ...
          <Row className="g-4 position-relative">
            <Col lg={10} xl={7} className="mx-auto text-center">
              <h3 className="text-white mb-3">Don't miss out - millions have joined Mizzle!</h3>
              ...
              <Col md={10} as={Form} className="bg-white bg-opacity-10 rounded-2 mx-auto p-2 mb-5">
                <FormGroup className="input-group">
                  <FormControl className="focus-shadow-none bg-transparent text-white border-0 me-1" type="email" placeholder="Your email address" />
                  <Button type="button" variant="primary" className="rounded-2 mb-0">Subscribe</Button>
                </FormGroup>
              </Col>
              <Swiper
                loop
