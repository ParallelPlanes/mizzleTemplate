import type { TestimonialType } from "@/pages/about/V3/types"
    ...
    <>
      ...
      <div className="d-sm-flex align-items-center mt-4">
        ...
        <div className="ms-sm-3 mt-2 mt-sm-0">
          <span className="heading-color fw-semibold mb-0">{user.firstName} {user.lastName}</span>
          <p className="mb-0 small">{user.role} {user.companyName && "of " + user.companyName}</p>
        </div>
      </div>
    </>
  )
