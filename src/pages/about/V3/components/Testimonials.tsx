...
import { testimonials } from "@/pages/about/V3/data"
...
const Testimonials = () => {
  ...
  return (
    <section className="pt-0">
      <Container>
        <div className="rounded-3 position-relative overflow-hidden p-4 p-md-6" style={{ background: `url(${backgroundImg5}) no-repeat`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <Col lg={4} className="mb-5 mb-lg-0">
              <div className="d-flex flex-column h-100">
                ...
                <div className="mt-auto">
                  <Link className="btn btn-lg btn-outline-white icon-link icon-link-hover" to="">Join our community<BsArrowRight className="bi"/> </Link>
                </div>
              </div>
            </Col>
