      ...
      <section className="pt-0">
        <Container>
          <Row>
            ...
            <Col xl={3} as={"aside"}>
              {width < 1200 ? (
                <Offcanvas show={showFilter} onHide={toggleFilter} placement='end' className="offcanvas-xl" tabIndex={-1} id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
              ...
              <Row as={Form} className="g-2 g-xl-4 mb-4">
                <Col md={6}>
                  <div className="rounded position-relative">
                    <input className="form-control bg-light pe-5" type="search" placeholder="Search products by name or keyword..." aria-label="Search" />
                    <button className="btn bg-transparent border-0 px-2 py-0 position-absolute top-50 end-0 translate-middle-y" type="submit"><BsSearch className="bi" /></button>
                  </div>
                </Col>
                ...
                {productGrid.map((product, idx) => {
                  return (
                    <Fragment key={idx}>
                      ...
                      {idx == 2 &&
                        <Col sm={6} lg={12}>
                          <Card className="card-body h-100 p-md-6" style={{ backgroundImage: `url(${backgroundImg5})`, backgroundPosition: 'center left', backgroundSize: 'cover' }}>
                            <Row className="align-items-center">
                              <Col lg={7} className="mb-4 mb-lg-0">
                                <h4 className="text-white mb-0">Checkout the newest smart watch product</h4>
                              </Col>
                              <Col lg={5} className="text-lg-end">
                                <Link to="" className="btn btn-white mb-0">Shop now</Link>
                              </Col>
                            </Row>
                          </Card>
                        </Col>
                ...
                <li>
                  <ul className="list-unstyled">
                    <li className="page-item disabled">
                      <Link className="page-link" to="" tabIndex={-1} aria-disabled="true">Prev</Link>
                    </li>
