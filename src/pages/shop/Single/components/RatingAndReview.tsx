...
import { reviews } from "@/pages/shop/Single/data"
              ...
              return (
                <Fragment key={idx}>
                  ...
                  <div className="d-flex">
                    <img className="avatar avatar-md rounded-circle float-start me-3" src={review.avatar} alt="avatar" />
                    <div>
                      <div className="d-sm-flex justify-content-between mb-2">
                        ...
                        <ul className="list-inline mb-0">
                          {review && Array(Math.floor(review.rating)).fill(0).map((_star, idx) => (
                          ...
                          {review && review.rating < 5 && Array(5 - Math.ceil(review.rating)).fill(0).map((_star, idx) => (
                            <li key={idx}
                      ...
                      <div className="btn-group ms-2" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label className="btn btn-outline-secondary btn-sm mb-0" htmlFor="btnradior1"><FaRegThumbsUp className="me-1" /> Yes</label>
                        <input type="radio" className="btn-check" name="btnradio1" id="btnradior2" />
                        <label className="btn btn-outline-secondary btn-sm mb-0" htmlFor="btnradior2"> No <FaRegThumbsDown className="ms-1" /></label>
                      </div>
                    </div>
                  </div>
                </Fragment>
            ...
            <Collapse in={isTrue}>
              <Card className="card-body">
                <Form>
                  ...
                  <button type="submit" className="btn btn-primary mb-0">Post It <BsArrowRight className="fa-fw  ms-2" /></button>
                </Form>
              </Card>
            </Collapse>
          </Col>
