          ...
          <Col lg={8} className="mb-6 mb-lg-0">
            <Card as={Form} className="bg-transparent">
              <CardHeader className="bg-transparent d-flex justify-content-between align-items-center border-bottom px-0 pt-0">
                ...
                <button className="btn btn-sm btn-danger-soft mb-0"><BsXLg className="me-1" />Clear cart</button>
              </CardHeader>
              <CardBody className="px-0">
                ...
                <div className="text-end">
                  <Link to="" className="btn btn-light border mb-0">Update cart</Link>
                </div>
              </CardBody>
            </Card>
            <Card className="card-body p-md-6 mt-5" style={{ backgroundImage: `url(${background5})`, backgroundPosition: 'center left', backgroundSize: 'cover' }}>
              <Col md={6}>
                <h4 className="text-white mb-4">Checkout the newest smart watch product</h4>
                <Link to="" className="btn btn-outline-white mb-0">Shop now</Link>
              </Col>
            </Card>
          </Col>
