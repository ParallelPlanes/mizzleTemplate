...
import {ClientType} from "@/pages/shop/Index/types";
...
export const brands: ClientType[] = [{image: client1}, {image: client2}, {image: client3}, {image: client4}, {image: client5}, {image: client6}, {image: client7}, {image: client8}]
