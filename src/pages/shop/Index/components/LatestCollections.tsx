...
import LatestCollectionCard from "@/pages/shop/Index/components/LatestCollectionCard";
...
const LatestCollections = () => {
    ...
    return (
        <Jarallax tag='section' className="bg-parallax position-relative" style={{
            background: `url(${shopBg4}) no-repeat`,
            ...
            <Container className="position-relative z-index-2">
                <Row>
                    <Col lg={8} xl={5} className="mb-5 mb-xl-0">
                        ...
                        <p className="text-white">Discover the perfect fusion of modern trends and timeless classics,
                            meticulously curated to complement your unique taste.</p>
                        <div className="d-flex gap-3 position-relative mt-5 mt-md-6">
                            <Link to=""
                                  className="btn btn-outline-white btn-icon rounded-circle mb-0 swiper-button-prev"><BsArrowLeft
                                size={16}/></Link>
                            <Link to=""
                                  className="btn btn-outline-white btn-icon rounded-circle mb-0 swiper-button-next"><BsArrowRight
                                size={16}/></Link>
                        </div>
                    </Col>
