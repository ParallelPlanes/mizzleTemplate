...
const Showcase = () => {
  return (
    <>
      <PageTitle title='Portfolio Showcase' />
                ...
                <Pagination className="pagination-primary-soft d-flex justify-content-between mb-0">
                  <li>
                    <ul className="list-unstyled">
                      <PageItem disabled>
                        <FaLongArrowAltLeft size={20} className="me-2 rtl-flip" />Prev
                      </PageItem>
                    </ul>
                  </li>
                  <li>
                    <ul className="list-unstyled">
                      <PageItem active className="page-item">1</PageItem>
                  ...
                  <li>
                    <ul className="list-unstyled">
                      <PageItem className="page-item">
                        Next<FaLongArrowAltRight size={20} className="ms-2 rtl-flip" />
                      </PageItem>
                    </ul>
                  </li>
                </Pagination>
              ...
              <Row className="g-4 position-relative">
                <Col lg={7} className="mx-auto text-center">
                  ...
                  <div className="d-sm-flex justify-content-center align-items-center gap-2">
                    <Link to="/contact/v1" className="btn btn-dark"><BsEnvelope className="me-2" />Email us</Link>
                    <Link to="/contact/v2" className="btn btn-dark"><BsTelephone className="me-2" />Contact us</Link>
                  </div>
                </Col>
              </Row>
            </div>
