    ...
    <Col xs={12}>
      <Row className="g-4 mt-7">
        ...
        <Col lg={5}>
          ...
          <p className="lead mb-4">Two assure Edward whence the was. Who worthy yet ten boys denote wonder. Weeks views her sight old tears sorry. Additions can suspected its concealed put furnished.</p>
        ...
        <Col lg={7} xl={6} className="ms-auto">
          ...
          <Row className="row-cols-2 row-cols-md-3 mt-lg-6 g-4 g-lg-5">
            ...
            <Col>
              <h2 className="mb-0">{currency}12.8<span className="text-primary mb-0">M</span></h2>
