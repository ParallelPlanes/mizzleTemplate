          ...
          <Container className="pt-4 pt-lg-0">
            <Row className="align-items-center mb-7">
              ...
              <Col xl={5} className="ms-auto">
                <p className="mb-4">The combination of my passion for design, code &amp; interaction positions me in a unique place in the web design world.</p>
                <div className="text-center d-inline-block bg-light border rounded px-5 py-3">
                  <span className="heading-color items-center">Work with us?</span> <Link className="ms-2" to="/contact/v2">Contact us now<BsChevronRight className="small ms-1" /></Link>
                </div>
              </Col>
            </Row>
            ...
            {(portfolioLists || []).map((item, idx) => {
              return idx % 2 ? (
                <ItemEndCard key={idx} {...item} />
              ) : (
                <ItemStartCard key={idx} {...item} />
              )
            })}
            ...
            <Row className="mt-7">
              <Col xs={12}>
                <Pagination className="pagination-primary-soft list-unstyled d-flex justify-content-center flex-wrap mb-0">
                  <PageItem>
                    <FaLongArrowAltLeft className="me-2 rtl-flip" />Prev
                  </PageItem>
                  <PageItem >1</PageItem>
                  ...
                  <PageItem>
                    Next<FaLongArrowAltRight className="ms-2 rtl-flip" />
                  </PageItem>
                </Pagination>
              </Col>
            </Row>
          ...
          <Container className="position-relative">
            <div className="bg-primary rounded position-relative overflow-hidden p-4 p-sm-5">
              ...
              <div className="position-absolute end-0 bottom-0 me-sm-5">
                <img src={ctaVectorImg} className="h-200px" alt="vector-img" />
              </div>
              <Row className="g-4 position-relative">
                <Col lg={7} className="mx-auto text-center">
                  ...
                  <p className="text-white mb-4">I'll take the time to understand your vision and goals, and work with you to develop a customized plan to help you succeed. </p>
                  <div className="d-sm-flex justify-content-center align-items-center gap-2">
                    <Link to="/contact/v1" className="btn btn-dark icons-center"><BsEnvelope className="me-2" />
                      Email us
                    </Link>
                    <Link to="/contact/v2" className="btn btn-dark icons-center"><BsTelephone className="me-2" />
                      Contact us
                    </Link>
                  </div>
                </Col>
