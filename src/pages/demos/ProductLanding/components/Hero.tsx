    ...
    return (
        <section className="bg-light position-relative overflow-hidden">
            <div className="text-end position-absolute top-0 end-0 mt-md-6 me-n4">
                <h6 className="mb-0" style={{fontSize: '350px', opacity: 0.03}}>Air</h6>
                <h6 className="mb-0" style={{fontSize: '350px', opacity: 0.03}}>Pods</h6>
            </div>

            <figure className="position-absolute bottom-0 start-0 mb-n8 ms-n7">
                <svg className="fill-body" width="805" height="234" viewBox="0 0 805 234" fill="none"
            ...
            <Container className="position-relative pt-5">
                <Row>
                    ...
                    <Col lg={7} className="mb-6 mb-lg-0">
                        ...
                        <p className="mb-4">Welcome to our AirPods landing page! Here, you will discover everything you
                            need to know about the revolutionary wireless earbuds from Mizzle.</p>
                        <Link to="" className="btn btn-lg btn-primary mb-0">Purchase Now</Link>
                        ...
                        <Row className="g-4 align-items-center">
                            ...
                            <Col sm={8}>
                                ...
                                <p className="heading-color mb-3">AirPods are also designed with comfort in mind. They
                                    come with different ear tip sizes to fit a variety of ear shapes and sizes.</p>


                                <div className="nav nav-tabs nav-tabs-radio border-0" role="tablist">

                                    <div className="nav-link p-0 me-2" data-bs-toggle="tab" data-bs-target="#white"
                                    ...
                                    <div className="nav-link p-0 me-2" data-bs-toggle="tab" data-bs-target="#yellow"
                                         aria-selected="false" role="tab">
                                    ...
                                    <div className="nav-link p-0 me-2" data-bs-toggle="tab" data-bs-target="#blue"
                                         aria-selected="false" role="tab">
                                    ...
                                    <div className="nav-link p-0 me-2" data-bs-toggle="tab" data-bs-target="#green"
                                         aria-selected="false" role="tab">
                    ...
                    <Col sm={10} lg={5} className="position-relative px-5 mx-auto">
                        <img src={heroProduct} alt="hero-img"/>

                        <div className="position-absolute top-0 start-0">
                            <div className="position-relative">
                                <OverlayTrigger placement="right" trigger='focus'
                                                overlay={<Popover className="p-2">
                                                    And here's some amazing content. It's very engaging. Right?
                                                </Popover>}>
                                    <Button variant='white' type="button"
                                            className="btn-ripple btn-round text-primary z-index-1 flex-centered">
                                        <BsPlusLg/>
                                    </Button>
                                </OverlayTrigger>
                                <figure className="position-absolute top-50 start-50 mt-n1">
                                    <svg width="249" height="69" viewBox="0 0 249 69" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="position-absolute bottom-0 end-0 me-lg-4 me-xl-8 mb-lg-9 mb-xl-7">
                            <div className="position-relative">
                                <OverlayTrigger placement="right" trigger='focus'
                                    ...
                                    <Button variant='white' type="button"
                                            className="btn-ripple btn-round text-primary z-index-1 mb-0 mt-n1 flex-centered">
                                        <BsPlusLg/>
                                    </Button>
                                </OverlayTrigger>

                                <figure className="position-absolute bottom-100 end-100 mb-n3">
                                    <svg width="175" height="90" viewBox="0 0 175 90" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 4V89H175" stroke="#DCE0E5"/>
                                        <circle className="fill-primary" cx="5" cy="5" r="5"
