...
import {features} from "@/pages/demos/ProductLanding/data";
                ...
                <Row className="g-0 bg-light rounded overflow-hidden">
                    ...
                    <Col md={6}>
                        <Card className="card-body bg-transparent d-block p-4 p-md-5 p-lg-7 h-100">
                            ...
                            <p className="mb-4">Why end might ask civil again spoil. Dinner she our horses depend
                                remember at children by reserved to vicinity. </p>
                            ...
                            <Link to="" className="btn btn-dark mb-0">Click here for more detail</Link>
                        </Card>
                    </Col>

                    <Col md={6}>
                        <div className="h-100 py-8 py-md-0"
                             style={{background: `url(${about8}) no-repeat`, backgroundSize: 'cover'}}></div>
                    </Col>
                </Row>
            </Container>
        </section>
