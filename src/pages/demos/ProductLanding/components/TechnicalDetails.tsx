        ...
        <section className="pb-0">
            <Container>
                ...
                <div className="inner-container text-center mb-4 mb-sm-6">
                    ...
                    <p className="mb-0">The sound quality of AirPods is impressive. They offer rich, clear, and
                        well-balanced audio performance, making them ideal for listening to music, watching movies, or
                        making calls.</p>
                </div>
                ...
                <Row className="g-4 align-items-center">
                    ...
                    <Col lg={4} className="order-1">
                        ...
                        <div className="d-flex justify-content-lg-end mb-4 mb-lg-8">
                            <div className="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
                                ...
                                <small>(Custom high-excursion, Noise Cancellation, Adaptive Transparency, Adaptive
                                    EQ)</small>
                            </div>

                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered">
                                <BsVolumeUp className="fa-xl"
                        ...
                        <div className="d-flex justify-content-lg-end mb-4 mb-lg-8 me-5">
                            <div className="text-lg-end order-1 ms-3 ms-lg-0 me-lg-3">
                                ...
                                <small>Height: 1.78 inches, Width: 2.39 inches, Depth: 0.85 inches, Weight: 1.79
                                    ounces</small>
                            </div>

                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered">
                                <BsRulers className="fa-xl" style={{height: '29px', width: '29px'}}/></div>
                        </div>
                        ...
                        <div className="d-flex justify-content-lg-end">
                            ...
                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 order-lg-2 flex-centered">
                                <BsSoundwave className="fa-xl" style={{height: '29px', width: '29px'}}/></div>
                        </div>
                    </Col>
                    ...
                    <Col md={7} lg={4} className="mx-auto position-relative order-lg-2">
                        ...
                        <img src={product2} className="px-4 z-index-1 position-relative"
                             alt="Technical-img"/>

                        <figure className="position-absolute top-50 start-0 mt-n8 ms-n7 ms-xl-n3 d-none d-md-block">
                            <svg className="fill-dark" style={{opacity: 0.04}} width="462" height="134"
                                 viewBox="0 0 462 134" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Col lg={4} className="order-3">
                        ...
                        <div className="d-flex mb-4 mb-lg-8">
                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
                                <BsBoxSeam className="fa-xl" style={{height: '29px', width: '29px'}}/></div>
                            <div className="ms-3">
                        ...
                        <div className="d-flex mb-4 mb-lg-8 ms-lg-5">
                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
                                <BsBatteryCharging className="fa-xl" style={{height: '29px', width: '29px'}}/></div>
                            <div className="ms-3">
                        ...
                        <div className="d-flex">
                            <div className="icon-lg bg-light heading-color rounded flex-shrink-0 flex-centered">
                                <BsFingerprint className="fa-xl" style={{height: '29px', width: '29px'}}/></div>
                            <div className="ms-3">
