...
import {partners} from "@/pages/demos/MobileApp/data";
            ...
            <Container className="position-relative pt-4 pt-sm-6">
                <Row>
                    <Col lg={6} className="mb-5 mb-sm-8 mb-md-9 mb-lg-0">
                        ...
                        <h1 className="position-relative lh-base mb-4">Get accurate plant diagnoses in an instant with
                            Mizzle.
                        ...
                        <p className="mb-5">Download the app for free and get access to accurate plant diagnoses with no
                            extra charges.</p>
                                    ...
                                    partners.map((partner, idx) => {
                                        ...
                                        return (
                                            <li className="list-inline-item" key={idx}>
                                                <Link to=""
                                                   className="btn btn-icon btn-lg btn-white bg-primary-hover shadow rounded-circle flex-centered">
                    ...
                    <Col lg={6} className="position-relative">
                        ...
                        <div className="avatar position-absolute bottom-0 end-0 me-8">
                            <img className="avatar-img rounded-circle" src={avatar14} alt="avatar"/>
                        </div>
