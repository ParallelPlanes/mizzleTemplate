...
const About = () => {
    return (
        <section className="pt-6 pt-lg-0 pb-0">
            <Container>
                <Row className="g-4 align-items-center">
                    ...
                    <Col lg={6} className="position-relative order-2">
                        ...
                        <div
                            ...
                            <p className="text-white small mb-0">Get instant help from our amazing team 🌱</p>
                        </div>
                        ...
                        <div
                            ...
                            <p className="text-dark small mb-0">Satisfied customers 🤗</p>
                        </div>
                        ...
                        <Row className="pe-md-6">
                            <Col xs={6} className="position-relative">
                                ...
                                <img src={about10} className="rounded-pill" alt="about-img"/>
                            </Col>
                            <Col xs={6} className="mt-8">
                                <img src={about11} className="rounded-pill" alt="about-img"/>
                            </Col>
                        </Row>
                    </Col>
                    ...
                    <Col lg={6} className="order-lg-2">
                        ...
                        <p className="mb-4 mb-lg-5">Take the guesswork out of diagnosing your plants with Mizzle. Our
                            app
                            uses advanced technology to quickly and accurately diagnose any plant problem, so you can
                            get back to enjoying your garden.</p>
                        ...
                        <Link to="" className="btn btn-dark mb-0">Start Free Trial</Link>
                    </Col>
                </Row>
            </Container>
        </section>
