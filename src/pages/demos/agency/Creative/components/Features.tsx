...
import { features } from "@/pages/demos/agency/Creative/data";
    ...
    <section className="bg-dark" data-bs-theme="dark">
      <Container className="mt-9">
        <Row className="align-items-start">
          ...
          <Col md={6} xl={5} className="position-relative">
            ...
            <Card className="card-body position-absolute top-0 end-0 mt-5 me-xl-n5">
            ...
            <img src={about5} className="rounded" alt="about-img" />
          </Col>

          <Col md={6} className="position-relative ms-auto mt-5 mt-md-0">
            <h2 className="mb-4 mb-md-5">Exploring Essential Platform Feature</h2>

            <Accordion defaultActiveKey="0"
              className="accordion-icon accordion-icon-start accordion-bg-light">
              {
                features.map((feature, idx) => (
                  <Accordion.Item eventKey={idx.toString()} className="mb-3" key={idx}>
                    <Accordion.Header as={'p'} className="font-base">
                      <span className='ps-5 fw-semibold'>
                        {feature.title}
                      </span>
                    </Accordion.Header>

                    <Accordion.Body className="mt-3 pb-0">
                      {feature.description}
                    </Accordion.Body>
                  </Accordion.Item>
                ))
