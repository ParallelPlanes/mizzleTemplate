import {
    ...
    ServiceType,
    TestimonialType
} from "@/pages/demos/agency/Creative/types";
...
export const testimonials: TestimonialType[] = [
    {
        comment: "Your assistance has been incredibly helpful. I appreciate the prompt and insightful responses, which have made my task much easier. Thank you for the great support",
        user: {
            avatar: avatar5,
            company: {
                name: "Blogzine",
    ...
    {
        comment: "It consistently delivers accurate and well-crafted responses, saving me a lot of time and effort. Thank you for this invaluable resource!",
        user: {
            avatar: avatar7,
            company: {
                name: "Blogzine",
...
export const features: FeatureType[] = [
    {
        ...
        description: "Collaborate seamlessly with team members in real time. Share drafts, make edits, and work together efficiently to create content that meets your goals. Sight House has sex never. No visit raising gravity outward subject."
    },
    {
        title: "Robust API Integration",
        description: "Our platform offers robust API integration options, allowing you to integrate our content generation capabilities into your existing software, apps, or platforms."
    },
    {
        title: "Privacy and Security",
        description: "We prioritize your data's security and privacy. Our platform adheres to the highest standards of data protection to ensure your content remains confidential and secure."
    },
    {
    ...
    },
    {
        ...
        description: "Offices for highest and replied one venture pasture. Applauded no discovery in newspaper allowance am northward. Frequently partiality possession resolution at or appearance unaffected me.."
    }
]
