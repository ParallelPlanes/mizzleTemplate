            ...
            <Container>
                ...
                <Row className="align-items-center mb-4 mb-md-6">
                    ...
                    <Col md={4} className="ms-auto text-md-end">
                        <Link to="" className="btn btn-dark mb-0">View all services</Link>
                    </Col>
                </Row>
                ...
                <Swiper
                    ...
                    <SwiperSlide>
                        <Card className="bg-primary p-5 mt-lg-7">
                            <Card.Header className="bg-transparent d-flex justify-content-between p-0 pb-6">
                                <h5 className="me-4 mb-0"><Link to="" className="stretched-link heading-color">SEO
                                    Training and Workshops</Link></h5>
                                <Link to=""
                                   className="btn btn-round btn-light border flex-shrink-0 flex-centered"><BsArrowUpRight/></Link>
                            </Card.Header>
                            ...
                            <Card.Body className="p-0">
                                ...
                                <p className="fw-semibold heading-color mb-0 mt-2">Fundamentals of SEO, Keyword
                                    research, Reporting, and Algorithm updates</p>
                            </Card.Body>
                        </Card>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Card className="bg-dark p-5 mt-lg-4" data-bs-theme="dark">
                            <Card.Header className="bg-transparent d-flex justify-content-between p-0 pb-6">
                                <h5 className="me-4 mb-0"><Link to="" className="stretched-link">Mobile SEO
                                    Optimization</Link></h5>
                                <Link to=""
                                   className="btn btn-round btn-light border flex-shrink-0 flex-centered"><BsArrowUpRight/></Link>
                            </Card.Header>
                            ...
                            <Card.Body className="p-0">
                                ...
                                <p className="fw-semibold heading-color mb-0 mt-2">Optimizing page speed, mobile
                                    responsiveness, and usability factors</p>
                            </Card.Body>
                        </Card>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <Card className="bg-light border p-5">
                            <Card.Header className="bg-transparent d-flex justify-content-between p-0 pb-6">
                                <h5 className="me-4 mb-0"><Link to="" className="stretched-link">Content Strategy
                                    and Creation</Link></h5>
                                <Link to=""
                                   className="btn btn-round btn-white border flex-shrink-0 flex-centered"><BsArrowUpRight/></Link>
                            </Card.Header>
                            ...
                            <Card.Body className="p-0">
                                ...
                                <span>What included:</span>
                                <p className="fw-semibold heading-color mb-0 mt-2">Audience Research, Keyword
                                    Analysis, Content Planning, Optimization</p>
                            </Card.Body>
                        </Card>
                    </SwiperSlide>
