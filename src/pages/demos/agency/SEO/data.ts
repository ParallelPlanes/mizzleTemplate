import {CaseStudyType, StepType, TestimonialType, MemberType} from "@/pages/demos/agency/SEO/types";
...
export const testimonials: TestimonialType[] = [
    {
        ...
        comment: "Our passion for customer excellence is just one reason why we are the market leader. We've always worked very hard to give our customers the best experience.",
    },
    {
        user: {
            firstName: "Emma",
        ...
        comment: "Was out laughter raptures returned outweigh. Luckily cheered colonel I do we attack highest enabled. Tried law yet style child. The bore of true of no be deal."
    },
    {
        user: {
            firstName: "Louis",
