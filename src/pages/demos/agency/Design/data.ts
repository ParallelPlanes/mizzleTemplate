...
import {BlogType, ProjectType, ServiceType, StatisticType, TestimonialType} from "@/pages/demos/agency/Design/types";
...
export const services: ServiceType[] = [
    ...
    },
    {
        ...
        description: "Make a lasting impression with a unique brand identity and logo design crafted to reflect your values and resonate with your target market.",
        image: serviceImg2,
    },
    {
        title: "Graphic Design",
        description: "From eye-catching graphics to captivating illustrations, our talented designers bring your ideas to life in stunning visual creations.",
        image: serviceImg3,
    },
    {
        title: "Social Media Graphics",
        description: "Our social media design services help you create visually appealing posts and ads that connect with your audience and drive results.",
        image: serviceImg4,
    },
    {
        title: "Motion Graphics",
        description: "Bring your brand to life with dynamic motion graphics and animations that capture attention and convey your message in an engaging way.",
        image: serviceImg5,
    }
]
...
export const testimonials: TestimonialType[] = [
    {
        ...
        comment: "We've partnered with Mizzle on multiple projects, and each time, they've delivered exceptional results. Their team goes above and beyond to understand our goals and deliver designs that resonate with our audience.",
        rating: 4.5,
    },
    {
        user: {
        ...
        comment: "It took our startup's branding to the next level with their exceptional design skills. They understood our vision and delivered a brand identity that perfectly captures our ethos. ",
        rating: 4.5,
    },
    {
        user: {
        ...
        comment: "Their team brings a level of creativity and innovation that's hard to find elsewhere. They're not just designers, they're strategic partners who are invested in the success of our projects. We look forward to continuing our partnership.",
        rating: 4.5,
    }
]
