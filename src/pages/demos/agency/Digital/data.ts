import {
    ...
    ServiceType,
    StepType,
    TestimonialType, BlogType
} from "@/pages/demos/agency/Digital/types";
...
export const testimonials: TestimonialType[] = [
    {
        ...
        comment: "As an employer, the platform exceeded my expectations. We swiftly found top-tier talent for our company, thanks to the user-friendly interface and the ability to connect with candidates that perfectly fit our requirements.",
        rating: 5,
        user: {
            firstName: "Louis",
            lastName: "Ferguson",
