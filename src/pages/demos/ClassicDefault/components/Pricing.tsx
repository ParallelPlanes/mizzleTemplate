    ...
    <section className="pb-0">
      <Container>
        <div className="inner-container text-center mb-4 mb-sm-6">
          ...
          <h2 className="mb-0 mt-4">Get a plan that grows with you</h2>
        </div>

        <Row>
          <Col lg={8}>
            <Card className="card-body bg-transparent h-100 px-0">
                ...
                <Col sm={6}>
                  <div className="d-flex justify-content-between mb-4 mb-sm-0">
                    <div>
                      ...
                      <div className="badge bg-dark text-white mb-3">
                        Boss mode
                      </div>
                      <h6 className="mb-3">
                        {" "}
                        <span className="display-2">{currency}59</span> /month
                      </h6>
                      <p className="mb-0">
                        The all-in-one solution for businesses that want to
                        succeed online.
                      </p>
                    </div>

                    <div className="vr opacity-1 ms-2 ms-md-5 d-none d-sm-block" />
                  </div>
                </Col>
                <Col sm={6} className="ps-md-5">
                  <h6 className="mb-sm-4">Features list of your need</h6>

                  <ul className="list-group list-group-borderless mb-3 mb-sm-4">
                  ...
                  <p className="mb-0">No credit card is required!</p>
                </Col>
              </Row>
            </Card>
          </Col>

          <Col lg={4} className="ms-auto mt-4 mt-lg-0">
            <Card className="bg-primary rounded h-100 overflow-hidden p-4">
              ...
              <Card.Body className="bg-transparent position-relative p-0">
                <div className="badge bg-dark text-white">Enterprise</div>
                <h4 className="text-white mb-0 mt-3">Custom pricing plan</h4>
              </Card.Body>

              <Card.Footer className="bg-transparent d-grid text-center p-0 mt-8">
                <Link to="/contact/v1" className="btn btn-white">
                  Contact Sales
                </Link>
