...
import {testimonials} from "@/pages/demos/ClassicDefault/data";
import TestimonialCard from "@/pages/demos/ClassicDefault/components/TestimonialCard";
                ...
                <Row>
                    ...
                    <Col lg={6} className="mb-5 mb-lg-0">
                        ...
                        >
                            ...
                            <div
                                className="swiper-pagination swiper-pagination-primary position-relative text-start"/>
                        </Swiper>

                    </Col>

                    <Col sm={10} lg={6} xl={5} className="position-relative ms-xl-auto">
                        ...
                        <figure
                            className="position-absolute top-50 start-0 translate-middle ms-n5 d-none d-xl-block">
                            <svg
                                width={144}
                                height={166}
                                viewBox="0 0 144 166"
                        ...
                        <Col sm={8} xs={11}
                             className="position-absolute top-0 start-0 mt-n2 mt-sm-7 ms-n2 ms-sm-n7">
                        ...
                        <div
                            className="bg-white rounded shadow d-flex align-items-center position-absolute bottom-0 start-0 mb-sm-5 ms-sm-n5 px-3 py-2">
