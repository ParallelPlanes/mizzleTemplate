...
export const testimonials: TestimonialType[] = [
  {
    comment: "We've seen a significant reduction in customer churn since implementing the mizzle - it's been a valuable addition to our customer retention efforts. The AI mizzle has allowed us to scale our customer support efforts without sacrificing quality",
    user: {
      avatar: avatar5,
      firstName: "Emma",
      lastName: "Watson",
