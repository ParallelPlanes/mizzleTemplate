        ...
        <Row className="row-cols-1 row-cols-lg-3 g-4">
          <Col>
            <Card className="card-body bg-light border p-sm-5">
              <div className="mb-4"><BsGeoAlt size={24} className="fa-xl text-primary" /></div>
          ...
          <Col>
            <Card className="card-body bg-light border p-sm-5">
              <div className="mb-4"><BsEnvelope size={24} className="fa-xl text-primary" /></div>
              <h6 className="mb-3">Email us</h6>
              <p>We're on top of things and aim to respond to all inquiries within 24 hours.</p>
              <Link to={`mail:${contactDetail.email}`} className="heading-color text-primary-hover text-decoration-underline mb-0">{contactDetail.email}</Link>
            </Card>
          </Col>
          <Col>
            <Card className="card-body bg-light border p-sm-5">
              <div className="mb-4"><BsTelephone size={24} className="fa-xl text-primary" /></div>
              <h6 className="mb-3">Call us</h6>
              <p>Let's work together towards a common goal - get in touch!</p>
              <Link to={`tel:${contactDetail.number}`} className="heading-color text-primary-hover text-decoration-underline mb-0">{contactDetail.number}</Link>
            </Card>
          </Col>
        </Row>
      </Container>
      <iframe className="w-100 h-200px h-lg-400px grayscale d-block mt-8" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095343008!2d-74.00425878428698!3d40.74076684379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sin!4v1586000412513!5m2!1sen!2sin" style={{ marginBottom: '-5px' }} aria-hidden="false" tabIndex={0} />
    </section>
