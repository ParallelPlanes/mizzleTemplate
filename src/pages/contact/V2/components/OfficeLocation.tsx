...
import type { LocationType } from "@/pages/contact/V2/types"
...
const OfficeLocation = () => {
  return (
    <Jarallax tag={"section"} className="bg-parallax position-relative" style={{ background: `url(${backgroundImg3}) no-repeat`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <Container>
