          ...
          <Col lg={10} className=" col-xl-8 mx-auto">
              ...
              <div className="d-flex justify-content-center mb-2">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb breadcrumb-dots mb-1">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Portfolio Showcase</li>
                  </ol>
                </nav>
              </div>
              <h2>{title ?? "UI/UX and Product Designer"}</h2>
            </div>
            <Card className="card-body bg-dark d-md-flex justify-content-md-between align-items-md-center flex-md-row p-5 mb-6" data-bs-theme="dark">
              <div className="mb-3 mb-md-0">
                ...
                <div className="hstack gap-3 gap-md-4 flex-wrap mt-3">
                  ...
                  <span className="icons-center"><BsGeoAlt className="me-2" />USA, ontario</span>
                  <span className="icons-center"><BsClock className="me-2" />San Francisco</span>
                  <span className="icons-center"><BsBriefcase className="me-2" />{currency}32,000</span>
                </div>
              </div>
              <a href="#contact-form" className="btn btn-primary mb-0">Apply now<BsArrowRight className="bi ms-2" /></a>
            </Card>
            <Row>
              <Col md={6}>
                <h6>Skills:</h6>
                <ul className="list-group list-group-borderless mb-4">
                  {skills.map((skill, idx) => (
                    <li className="list-group-item d-flex mb-0 icons-center" key={idx}><BsPatchCheck className="text-primary me-2" />{skill}</li>
                  ))}
                </ul>
              </Col>
              <Col md={6}>
                ...
                <ul className="list-group list-group-borderless mb-4">
                  <li className="list-group-item d-flex mb-0 icons-center"><BsPatchCheck className="text-primary me-2" />Writing SEO Performant Code</li>
                  <li className="list-group-item d-flex mb-0 icons-center"><BsPatchCheck className="text-primary me-2" />Converting Design to Code</li>
                </ul>
              </Col>
              <Col md={6}>
                <h6>Experience:</h6>
                <ul className="list-group list-group-borderless mb-4">
                  <li className="list-group-item mb-0 icons-center"><BsPatchCheck className="text-primary me-2" />Bachelor Degree</li>
                </ul>
              </Col>
              <Col md={6}>
            ...
            <Row className="mt-5">
              <Col md={6}>
                ...
                <p>If you need to send us mail regarding job opportunities, please write to us at <Link to="">info@example.com</Link> for more information.</p>
              </Col>
              <Col md={6}>
                <h6>Apply via phone number</h6>
                <p className="mb-1">Apply Now Via Whats App, Send us Your Resume on:</p>
                <Link to="">+79 2589 63598</Link>
              </Col>
            </Row>
            <Card className="card-body bg-light border p-sm-5 mt-5" id="contact-form">
              <Row as={Form} className="g-4" onSubmit={handleSubmit(() => { })}>
                ...
                <Col xs={12} className="d-grid">
                  <button className="btn btn-lg btn-primary mb-0" type="submit">Send a message</button>
                </Col>
              </Row>
            </Card>
          </Col>
