...
import {
    ...
    ToolType,
    WorkFlowStepType
} from "@/pages/saas/V4/types";


export const clients: ClientType[] = [{image: client5}, {image: client1}, {image: client7}, {image: client2}, {image: client3}, {image: client4}, {image: client6}, {image: client7}]
...
export const testimonials: TestimonialType[] = [
    ...
    },
    {
        ...
        comment: "Fulfilled direction use continually set him propriety continued. Farther-related bed and passage comfort civilly. Concluded boy perpetual old supposing.",
        rating: 4.5,
    },
    {
        user: {
...
export const blogs: BlogType[] = [
    ...
    },
    {
        ...
        title: "Webestica Template: The Ultimate Web Design Solution",
        image: blog1,
        url: '/blog/single/v1',
    },
    {
