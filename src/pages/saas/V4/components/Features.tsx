                ...
                <Tab.Container defaultActiveKey="0">
                    <Row>
                        <Col lg={6} xxl={5} className="pe-5 pe-xxl-0 order-2">
                            <div className="bg-primary bg-opacity-10 rounded position-relative h-100 p-5">
                                ...
                                <figure className="position-absolute top-0 start-0 ms-n7 mt-n5">
                                    <svg className="fill-mode" width="156" height="153" viewBox="0 0 156 153"
                                         fill="none"
                                ...
                                <Tab.Content className="h-100">
                                    <Tab.Pane eventKey="0" className="fade h-100">
                                        <div className="d-flex h-100">
                                            <img src={decoration10} className="m-auto"
                                                 alt="decoration"/>
                                        </div>
                                    </Tab.Pane>

                                    <Tab.Pane eventKey="1" className="fade h-100">
                                        <div className="d-flex h-100">
                                            <img src={decoration12} className="m-auto"
                                                 alt="decoration"/>
                                        </div>
                                    </Tab.Pane>

                                    <Tab.Pane eventKey="2" className="fade h-100">
                                        <div className="d-flex h-100">
                                            <img src={decoration11} className="m-auto"
                                                 alt="decoration"/>
                                        </div>
                                    </Tab.Pane>
                                </Tab.Content>
                        ...
                        <Col lg={6} className="ms-auto h-100 order-1 order-lg-2 mb-5 mb-lg-0">
                            ...
                            <p className="mb-4">Comfort reached gay perhaps chamber his six detract besides add.
                                Moonlight
                                newspaper up its enjoyment.</p>

                            <Nav variant='pills' className="nav-pills-border-start flex-column mb-3">

                                <Nav.Link eventKey="0" className="p-3 p-sm-4 mb-2">
                                    <div className="d-flex">
                                        ...
                                        <div className="ms-3">
                                            ...
                                            <p className="text-body text-wrap mb-0">Drawings offended yet answered
                                                perceive
                                                laughing six did far.</p>
                                        </div>
                                    </div>
                                </Nav.Link>

                                <Nav.Link eventKey="1" className="p-3 p-sm-4 mb-2">
                                    <div className="d-flex">
                                        <div className="icon-lg bg-body heading-color flex-shrink-0 border rounded flex-centered">
                                        ...
                                        <div className="ms-3">
                                            ...
                                            <p className="text-body text-wrap mb-0">Demesne's new manners savings
                                                staying
                                                had under folly balls.</p>
                                        </div>
                                    </div>
                                </Nav.Link>

                                <Nav.Link eventKey="2" className="p-3 p-sm-4 mb-2">
                                    <div className="d-flex">
                                        <div className="icon-lg bg-body heading-color flex-shrink-0 border rounded flex-centered">
                                        ...
                                        <div className="ms-3">
                                            ...
                                            <p className="text-body text-wrap mb-0">Express besides it present if at an
                                                opinion visitor.</p>
                                        </div>
                                    </div>
                                </Nav.Link>
                            ...
                            <p className="mt-3 mb-0">
                                <BsInfoSquareFill className="heading-color me-2"/>Contact our team for more
                                information {" "}
                                <Link to="/contact/v1" className="icon-link icon-link-hover text-decoration-underline">Let's
                                    chat<BsArrowRight className="bi"/>
                                </Link>
                            </p>
