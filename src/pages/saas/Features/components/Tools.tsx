          ...
          <Col xl={4}>
            <Card className="card-body d-flex p-4 border h-100 flex-md-row flex-xl-column">
              ...
              <div className="me-md-5 me-xl-0 mb-4 mb-md-0">
                ...
                <Card.Title as={'h5'} className="mb-3">Expertise in SaaS implements</Card.Title>
                <p className="mb-3">Our platform offers a comprehensive suite of features designed to
                  empower your business.</p>
                <Link to="" className="btn btn-dark mb-0">View Integration</Link>
              </div>
                  ...
                  <Row className="g-4">
                    <Col md={6}>
                      <Card.Body className="p-0">
                        ...
                        <Card.Title as={'h5'} className="mb-3">Collaborating on work shouldn't
                          be this
                          hard</Card.Title>
                        <p className="mb-3">We provide digital transformation solutions,
                          enabling companies to make their visions. </p>
                        <Link to="" className="btn btn-outline-primary mb-5">Explore Now</Link>
                      </Card.Body>
                    </Col>
                    ...
                    <Col md={6}>
                      <div className="me-n9 mb-n6">
                        <img src={featureImg}
                          className="card-img border border-dark border-5"
                          alt="feature-img" />
                      </div>
                    </Col>
                  </Row>
              ...
              <Col lg={6}>
                <Card className="bg-dark rounded h-100 overflow-hidden p-5">
                  <figure className="position-absolute bottom-0 end-0 mb-n4 me-n5">
                    <svg className="fill-white opacity-1" width="220px" height="209px"
                      viewBox="0 0 220 209">
                      <path
                  ...
                  <Card.Footer className="bg-transparent p-0 mt-6">
                    <Link to="/portfolio/list" className="btn btn-white mb-0">See our work</Link>
                  </Card.Footer>
                </Card>
              </Col>
              ...
              <Col lg={6}>
                <Card className="bg-light rounded h-100 overflow-hidden p-4">
                  <Card.Body className="bg-transparent p-0">
                    ...
                    <p className="mb-0">Ample order up in of in ready. Timed blind had now those
                      ought set often which. Or snug dull he show more true wish.</p>
                  </Card.Body>
