            ...
            <Col lg={10} xl={8} xxl={6} className="mx-auto mb-6 mb-xl-8">
              <div className="bg-light rounded-pill p-2">
                <Nav variant='pills'
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey='analytics' className="nav-link rounded-pill icons-center">
                      <BsFunnel className="me-2" />Analytics
                    </Nav.Link>
                  </Nav.Item>

                  <Nav.Item>
                    <Nav.Link eventKey='collaboration' className="rounded-pill icons-center">
                  ...
                  <Nav.Item className="position-relative">
                    ...
                    <Nav.Link className="rounded-pill icons-center">
                  ...
                  <Row className="align-items-center">
                    ...
                    <Col lg={6} className="mb-6 mb-lg-0">
                      ...
                      <Link className="btn btn-white icon-link icon-link-hover" to="">Explore
                        analytics<BsArrowRight className='bi'/> </Link>
                    </Col>
                      ...
                      <Col md={8}
                        ...
                        <div className="bg-body rounded p-3">
                          <div
                            ...
                            <div
                              className="icon-md bg-primary bg-opacity-10 rounded-circle text-primary flex-shrink-0">
