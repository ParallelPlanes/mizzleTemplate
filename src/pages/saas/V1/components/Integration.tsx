                    ...
                    <Col lg={6} className="pe-xl-5 order-2">
                        <Row className="align-items-sm-center">
                            ...
                            <Col xs={6} sm={4} className="d-none d-sm-block">
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={slackImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                                ...
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={shopifyImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                            ...
                            <Col sm={4} xs={6}>
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={redditImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                                ...
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={googleImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                                ...
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={dropboxImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                            ...
                            <Col sm={4} xs={6}>
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={googleDriveImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
                                ...
                                <div className="bg-light rounded-4 text-center p-4 mb-4">
                                    <div className="icon-xl bg-body rounded-circle mx-auto mb-2">
                                        <img src={mailchimpImg} className="h-40px"
                                             alt="Integration-img"/>
                                    </div>
