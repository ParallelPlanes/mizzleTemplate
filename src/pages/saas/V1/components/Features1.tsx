...
import {features, statData} from "@/pages/saas/V1/data";
                ...
                <Row className="align-items-start">
                    ...
                    <Col lg={6} xl={5} className="position-relative text-center order-1 mt-6 mt-lg-0">
                        ...
                        <figure className="position-absolute bottom-0 end-0 mb-n6 me-n6 d-none d-xl-block">
                            <svg className="fill-white" width="170" height="133" viewBox="0 0 170 133" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div
                            className="bg-dark text-center p-4 rounded position-absolute top-0 end-0 z-index-1 d-none d-sm-block my-3 mx-4">
                            <h3 className="text-white mb-0">89%</h3>
                            <p className="mb-0">Company growth</p>
                        </div>

                        <Col md={6}
                             className="card card-body bg-white text-center position-absolute top-100 start-0 ms-xl-n8 mt-n8 z-index-1">
                            ...
                            <p className="text-dark mb-0">Keep your info updated to increase the number of
                                intersection </p>
                        </Col>

                        <img src={about6} className="rounded position-relative" alt="about-img"/>
                    </Col>
                    ...
                    <Col lg={6} className="ms-auto position-relative order-lg-2">
                        ...
                        <p className="mb-4 mb-md-5">Efficiently evaluate your digital content for accessibility,
                            identifying and resolving issues swiftly to ensure an inclusive user experience.</p>
