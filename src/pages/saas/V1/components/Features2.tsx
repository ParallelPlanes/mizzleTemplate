            ...
            <Container>
                <Row className="g-4">
                    ...
                    <Col lg={6} className="mb-sm-6 mb-lg-0">
                        ...
                        <p className="mb-0">Supposing so be resolving breakfast am or perfectly. It drew a hill from me.
                            Valley by oh twenty direct me so.</p>
                        ...
                        <Row className="g-4 mb-4 mb-sm-5">
                            <Col sm={6}>
                                ...
                                <div className="d-flex mb-4 mb-sm-5">
                                    <div
                                        className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered">
                                        <BsDiagram3 size={19} className="fa-xl"/></div>
                                ...
                                <div className="d-flex">
                                    <div
                                        className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered">
                                        <BsBoxes size={19} className="fa-xl"/></div>
                            ...
                            <Col sm={6}>
                                ...
                                <div className="d-flex mb-4 mb-sm-5">
                                    <div
                                        className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered">
                                        <BsPeople size={19} className="fa-xl"/></div>
                                ...
                                <div className="d-flex">
                                    <div
                                        className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered">
                                        <BsShieldCheck size={19} className="fa-xl"/></div>
                        ...
                        <Link to="/about/v2" className="btn btn-dark mb-0">Know more information</Link>
                    </Col>
                        ...
                        <Row>
                            <Col lg={11} xl={9} className="position-relative ms-auto">
                                ...
                                <figure className="position-absolute top-50 start-0 translate-middle z-index-2">
                                    <svg width="159" height="155" viewBox="0 0 159 155" fill="none"
                                ...
                                <figure
                                    className="position-absolute top-0 start-100 translate-middle mt-8 ms-5 d-none d-xl-block">
                                ...
                                <Card className="border p-4">
                                    ...
                                    <img src={about7} className="card-img mb-3" alt="card image"/>
                                    ...
                                    <Link to="" className="btn btn-dark-soft mb-0">View case study</Link>
                                </Card>


                                <div
                                    className="bg-body rounded-4 shadow d-flex align-items-center position-absolute top-0 end-0 d-none d-sm-flex mt-n5 me-xl-n6 p-3">
                                ...
                                <ul className="list-inline bg-body d-flex flex-column rounded shadow position-absolute top-0 start-0 d-none d-sm-flex p-2 mb-0 mt-3 ms-xl-n5">
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-facebook"
                                                                             to="">
                                        <FaFacebookF className="fa-fw lh-base"/></Link></li>
                                    <li className="list-inline-item me-0"><Link
                                        className="btn btn-xs btn-icon bg-instagram"
                                        to="">
                                        <FaInstagram className="fa-fw lh-base"/></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-twitter"
                                                                             to="">
                                        <FaTwitter className="fa-fw lh-base"/></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-linkedin"
                                                                             to="">
                                        <FaLinkedinIn className="fa-fw lh-base"/></Link></li>
                                    <li className="list-inline-item me-0"><Link className="btn btn-xs btn-icon bg-youtube"
                                                                             to="">
                                        <FaYoutube className="fa-fw lh-base"/></Link></li>
                                </ul>
                            </Col>
                        </Row>
                    </Col>
