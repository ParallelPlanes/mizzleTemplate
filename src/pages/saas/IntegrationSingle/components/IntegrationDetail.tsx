...
import { integrations } from "@/pages/saas/IntegrationSingle/data"
      ...
      <Container className="pt-4 pt-lg-0">
        <Row>
          <Col xl={9} className="mx-auto">
            ...
            <p>Integrating Slack with Mizzle is a game-changer. With this integration, you can effortlessly synchronize data, messages, and tasks between our software and Mizzle. Enjoy real-time updates, improved communication, and a more organized workflow.</p>
            ...
            <p>Our integration with Slack takes your team collaboration to the next level. By connecting Mizzle with Slack, you can create a more efficient and productive work environment.</p>
            <ul className="list-group list-group-borderless mb-4">
              <li className="list-group-item heading-color d-flex mb-0 icons-center">
                <BsArrowRight className="me-2" />Instant Notifications
              </li>
              <li className="list-group-item heading-color d-flex mb-0 icons-center">
                <BsArrowRight className="me-2" />File Sharing
              </li>
              <li className="list-group-item heading-color d-flex mb-0 icons-center">
                <BsArrowRight className="bi me-2" />Seamless Communication
              </li>
            </ul>
            <p className="mb-4">This content provides an overview of how your SaaS product integrates with Mizzle and Slack, highlighting the key features and benefits of these integrations. It encourages visitors to take action and explore these integrations further.</p>
            <Link to="" className="btn btn-dark mb-0">Get Started</Link>
          </Col>
