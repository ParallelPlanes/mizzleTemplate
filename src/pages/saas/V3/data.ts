...
import {StatisticType, ClientType, FeatureType} from "@/pages/saas/V3/types";

export const clients: ClientType[] = [{image: client1}, {image: client2}, {image: client3}, {image: client4}, {image: client5}, {image: client6}, {image: client7}]
