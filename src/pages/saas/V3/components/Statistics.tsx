...
import {statData} from "@/pages/saas/V3/data";
            ...
            <Container>
                <Row className="g-4">
                    <Col xl={7} className="position-relative pe-xl-4 order-2">
                        ...
                        <Row className="position-relative">
                            <Col sm={6} xl={5} className="mt-auto">
                                <img src={decoration5}
                                     className="d-none d-sm-block" alt="Decoration-img"/>
                            </Col>
                            <Col sm={6}>
                                <img src={about14} className="shadow rounded-4" alt="About-img"/>
                            </Col>
                        </Row>
                        ...
                        <Row className="mt-4 position-relative">
                            <Col xs={7} className="mt-auto">
                                <img src={decorationImg} className="shadow rounded-4" alt="Decoration-img"/>
                            </Col>
                            <Col xl={4} xs={5}>
                                <img src={decoration6} className="shadow rounded-4" alt="Decoration-img"/>
                            </Col>
                        </Row>
                    </Col>
                    ...
                    <Col xl={5} className="order-1 order-xl-2 ms-auto">
                        ...
                        <p className="mb-4 mb-xl-5">With a track record of success, we're here to guide you through the
                                    ...
                                    <Col key={idx}>
                                        <div className="bg-light p-4 rounded-3">
                                            <div className="d-flex">
                                                {
                                                    item.prefix &&
                                                    <span className="h4 text-primary mb-0">{item.prefix}</span>
                                                }
                        ...
                        <div className="d-flex align-items-sm-center">
                            ...
                            <div className="ms-3">
                                <p className="fs-6 fw-normal heading-color mb-4">"We believe that it takes great people
                                    to deliver a great product"</p>
