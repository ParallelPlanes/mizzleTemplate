      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col lg={5} className="mb-5 mb-sm-0">
            ...
            <p className="mb-4">Read what our satisfied clients have to say about their experiences with our
              platform.</p>
            ...
            <Row className="g-4">
              <Col md={6}>
                <Card className="card-body card-hover-shadow border p-4 mb-4">
                  ...
                  <p className="heading-color mb-4">"Frequently partiality possession resolution at or
                ...
                <Card className="card-body card-hover-shadow border p-4">
                  ...
                  <p className="heading-color mb-4">"Was out laughter raptures returned outweigh.
              ...
              <Col md={6} className="mt-md-7">
                ...
                <Card className="card-body card-hover-shadow border p-4 mb-4">
                  ...
                  <p className="heading-color mb-4">"Two before narrow not relied on how except moment
                    myself Dejection assurance Mrs led certainly So gate at no only none open
                    Betrayed."</p>
                ...
                <Card className="card-body card-hover-shadow border p-4">
                  ...
                  <p className="heading-color mb-4">"Our passion for customer excellence is just one
