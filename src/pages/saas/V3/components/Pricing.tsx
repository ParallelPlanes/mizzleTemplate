...
const Pricing = () => {
    return (
        <section className="pb-0">
            <Container>
                <Row className="g-4 g-sm-6 g-xl-7">

                    <Col lg={6}>
                        <Card className="bg-light overflow-hidden p-0 h-100">

                            <figure className="position-absolute top-0 end-0 mt-n6 me-n6">
                                <svg className="fill-primary opacity-2" width="220px" height="209px"
                                     viewBox="0 0 220 209">
                                    <path
                            ...
                            <Card.Body className="position-relative p-sm-6 pb-lg-0">
                                <h2 className="mb-4">Anywhere, Any Time, Any Platform</h2>
                                <p className="heading-color mb-4">Download the app for free and get access to accurate
                                    plant diagnoses with no extra charges.</p>

                                <Row className="g-2">

                                    <Col sm={4} lg={6} xl={4} xs={6}>
                                        <Link to=""> <img src={googlePlay}
                                                          className="btn-transition" alt="google-store"/> </Link>
                                    </Col>

                                    <Col sm={4} lg={6} xl={4} xs={6}>
                                        <Link to=""> <img src={appStore}
                                                          className="btn-transition" alt="app-store"/> </Link>
                                    </Col>
                                </Row>
                            </Card.Body>

                            <Card.Footer className="bg-transparent p-0">
                                <img src={saasScreen} className="ms-5" alt=""/>
                            </Card.Footer>
                        </Card>
                    </Col>
                    ...
                    <Col lg={6}>
                        <Card className="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
                            <div className="position-absolute end-0 bottom-0 mb-n3 me-n3">
                                <img src={patternImg} className="opacity-1" alt=""/>
                            </div>

                            <Card.Header className="text-center bg-transparent position-relative">
                                <img src={logoIcon} className="mb-4" alt="logo-icon"/>
                                <h3 className="mb-2">Affordable pricing pack</h3>
                                <p>Our essential plan is self-service solution for businesses to handle website
                                    messaging and personalization</p>
                            </Card.Header>

                            <Card.Body className="bg-light border rounded mx-2 mx-sm-4 position-relative">
                                <h6 className="mb-3">Quick look at all the features</h6>

                                <ul className="list-group list-group-borderless">
                                    <li className="list-group-item mb-0 icons-center">
                                        <BsPatchCheckFill className="text-primary me-2"/>Unlimited monthly
                                        visitors
                                    </li>
                                    <li className="list-group-item mb-0 icons-center">
                                        <BsPatchCheckFill className="text-primary me-2"/>Dedicated SEO
                                        strategists
                                    </li>
                                    <li className="list-group-item mb-0 icons-center">
                                        <BsPatchCheckFill className="text-primary me-2"/>Google Docs style
                                        editors
                                    </li>
                                    <li className="list-group-item mb-0 icons-center">
                                        <BsPatchCheckFill className="text-primary me-2"/>Basic chat and email
                                        support
                                    </li>
                                    <li className="list-group-item mb-0 icons-center">
                                        <BsPatchCheckFill className="text-primary me-2"/>AI powered product
                                        recommendation engine
                                    </li>
                                </ul>
                            </Card.Body>

                            <Card.Footer className="card-footer text-center bg-transparent position-relative mt-3">

                                <div className="mb-4 heading-color"><span className="h2">{currency}299</span> /month
                                </div>

                                <Link to="" className="btn btn-lg btn-primary w-100 mb-0">Get 1 year access</Link>
                            </Card.Footer>
                        </Card>
                    </Col>
                </Row>
