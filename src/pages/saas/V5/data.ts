import {BlogType, ClientType, FeatureType, PricingPlanType} from "@/pages/saas/V5/types";
...
export const clients: ClientType[] = [{image: client3}, {image: client7}, {image: client5}, {image: client4}, {image: client1}, {image: client2}, {image: client3}, {image: client6}]
