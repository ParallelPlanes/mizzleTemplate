...
import {pricingData} from "@/pages/saas/V5/data";
                        ...
                        <Col xl={6} className="h-100 pe-sm-7">
                            <div className="d-xl-flex justify-content-between">
                                <div>
                                    ...
                                    <p className="mb-4">Our passion for customer excellence is just one reason why we
                                        are the market leader. We've always worked very hard to give our customers the
                                        best experience.</p>
                                    <Link className="btn btn-white icon-link icon-link-hover" to="/pricing">View
                                        pricing<BsChevronRight className="bi"/> </Link>
                                </div>
                            ...
                            <Row>
                                ...
                                <Col sm={6}>
                                    <div className="icon-lg text-primary bg-white rounded-circle mb-3 m-md-start flex-centered">
                                        <BsRocketTakeoff size={24} className="fa-lg"/></div>
                                    <p className="text-secondary fw-semibold mb-3">Unlimited users</p>
                                    <h6 className="mb-1"><span
                                        className="fs-1">{currency}{pricingData.price}</span> /month</h6>
