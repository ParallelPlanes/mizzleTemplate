                ...
                <Row className="g-4 g-xl-6">
                    <Col lg={6}>
                        <Card className="border p-0 h-100">
                            <Card.Body className="p-4 py-sm-5 px-sm-7 text-center">
                                <h5 className="mb-3">Work with your favorite tools</h5>
                                <p className="mb-4">You have the freedom to use the tools and software you prefer or
                                    find most effective in your job or tasks.</p>
                                <Link to="/saas/integrations" className="btn btn-sm btn-dark mb-0">View all
                                    integrations</Link>
                            </Card.Body>

                            <Card.Footer className="p-0">
                                <img src={decoration18} alt=""/>
                            </Card.Footer>
                        </Card>
                    </Col>
                    ...
                    <Col lg={6}>
                        <Card className="border overflow-hidden p-0 h-100">
                            <Card.Body className="p-4 py-sm-5 px-sm-7 text-center">
                                ...
                                <p className="mb-4">Code you're providing or generating is of high quality, thoroughly
                                    tested, and fully prepared for deployment.</p>
                                <Link to="" className="btn btn-sm btn-dark mb-0">Discover our theme</Link>
                            </Card.Body>

                            <Card.Footer className="p-0 mb-n3 ms-5">
                                <img src={decoration19} alt=""/>
                            </Card.Footer>
                        </Card>
                    </Col>
