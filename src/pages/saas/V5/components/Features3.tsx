            ...
            <Container>
                <Row className="align-items-center">
                    ...
                    <Col lg={6} xl={5} className="mb-6 mb-lg-0">
                        ...
                        <p className="mb-sm-5">Streamline your tasks and achieve more with a single, all-encompassing
                            platform designed to meet your needs from start to finish.</p>
                        ...
                        <div className="d-flex align-items-center mb-4">
                            ...
                            <p className="heading-color mb-0">A Wide Range of Clients, Spanning Freelancers to Corporate
                                Giants</p>
                        </div>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <p className="heading-color mb-0">Resolved all kinds of questions and inquiries over the
                                last 5 years</p>
                        </div>
                    </Col>
                    ...
                    <Col lg={6} className="ms-auto">
                        <div className="position-relative d-flex flex-column h-100">
                            ...
                            <Col md={9} className="mx-auto z-index-2">
                                <img src={decoration23} alt=""/>
                            </Col>

                            <div
                                className="bg-light border rounded-3 h-50 w-100 position-absolute bottom-0 start-0"></div>
                        </div>
                    </Col>
                </Row>
            </Container>
