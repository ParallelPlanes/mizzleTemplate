...
import {features} from "@/pages/saas/V5/data";
                ...
                <Row className="align-items-center">
                    <Col lg={6} className="position-relative pe-lg-7 order-2">
                        ...
                        <figure className="position-absolute top-50 start-50 translate-middle">
                            <svg className="fill-light" width="451" height="374" viewBox="0 0 451 374" fill="none"
                        ...
                        <Row className="justify-content-center position-relative">
                            <Col xs={9}>
                                <img src={decoration2} className="mb-4"
                                     alt=""/>
                            </Col>
                            ...
                            <Col xs={5} className="me-auto">
                                <img src={decoration16} className="rounded-3 shadow"
                                     alt=""/>
                            </Col>
                        </Row>
                    </Col>
