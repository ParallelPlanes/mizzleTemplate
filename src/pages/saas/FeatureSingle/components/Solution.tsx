      ...
      <Container>
        ...
        <Row className="g-4 g-lg-5">
          <Col md={5} className="h-100">
            <img src={about5} className="rounded-3" />
          </Col>
              ...
              <Col xs={12}>
                <Card className="bg-light rounded h-100 overflow-hidden p-5">
                  <CardBody className="bg-transparent p-0">
                    ...
                    <p className="small mb-0">Unlock the full potential of your business and elevate it to new heights by harnessing the power of cutting-edge tools and technologies available today.</p>
                  </CardBody>
                  <CardFooter className="bg-transparent text-end p-0 mt-3">
