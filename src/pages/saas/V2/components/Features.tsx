...
import {Card, Col, Container, Nav, ProgressBar, Row, Tab} from "react-bootstrap";
        ...
        <section className="bg-dark position-relative overflow-hidden" data-bs-theme="dark">
            ...
            <figure className="position-absolute top-0 end-0 me-n9 mt-n7 d-none d-md-block" >
                <svg className="fill-white" width="768.8px" height="1386px" viewBox="0 0 768.8 1386" style={{opacity:0.07}}>
                    ...
                    <path
                        d="M636.2,722.3c23.4,73.7-25.2,149.2-76.5,228.7c-40.8,63.5-83,129.1-91.9,198.3c-9.9,78.2,25.9,150,109.6,219 l-0.4,0.7c-45-37.1-75.4-74-93.5-112.7c-15.9-34.5-21.2-69.5-16.5-106.8c8.9-69.5,51-135.1,91.9-198.6 C616.4,861.3,671,776.5,622,694.1c-39.6-66.6-102.4-118.8-169-174.2c-68.7-57.3-140-116.4-188.1-195.3 c-25.9-42.6-42.9-86.9-51.5-135.2c-9.8-54.6-9.2-112.9,2-177.9l0.6,0.1c-46.5,271.4,97.9,391.7,237.5,507.9 c66.7,55.4,129.4,107.7,169.1,174.5C628.8,702.7,633.1,712.6,636.2,722.3z"></path>
                    <path
                    ...
                    <Row>
                        <Col lg={10} xl={8} xxl={6} className="mx-auto mb-6 mb-xl-8">
                            <div className="bg-light rounded-pill p-2">
                                <Nav variant='pills'
                                     className="nav-pills-primary nav-responsive justify-content-between">

                                    <Nav.Item>
                                        <Nav.Link eventKey='analytics' className="nav-link rounded-pill">
                                            <BsFunnel className="me-2"/>Analytics
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item>
                                        <Nav.Link eventKey='collaboration' className="rounded-pill">
                                            <BsBasket className="me-2"/>Collaboration
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item className="position-relative">
                                    <span
                                        className="badge text-bg-danger position-absolute top-0 start-100 translate-middle mt-n2 ms-n5 d-none d-lg-block">Coming soon</span>
                                        <Nav.Link className="rounded-pill">
                                            <BsGear className="me-2"/>Automation
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item>
                                        <Nav.Link className="rounded-pill">
                                            <BsPieChart className="me-2"/>Scalability
                                        </Nav.Link>
                                    </Nav.Item>
                        ...
                        <Col xs={11} className="mx-auto">
                            <Tab.Content>
                                <Tab.Pane eventKey='analytics' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">Analytics</span>
                                            <h3 className="my-4">Comprehensive data analytics and reporting</h3>
                                            <p>Gain valuable insights into your digital campaigns with our comprehensive
                                                data analytics and reporting feature.</p>

                                            <ul className="list-group list-group-borderless mb-4">
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Actionable
                                                    recommendations
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Cross-channel
                                                    analysis
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>User-friendly
                                                    interface
                                                </li>
                                            </ul>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="">Explore
                                                analytics<BsArrowRight/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <figure className="position-absolute top-0 start-0 ms-n5 mt-n5" >
                                                <svg className="opacity-2" width="148" height="140"
                                                     viewBox="0 0 148 140"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <circle className="fill-primary" cx="25.86" cy="131.41"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="44.71" cy="131.41"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="63.57" cy="131.41"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="82.43" cy="131.41"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="101.29" cy="131.41"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="120.14" cy="131.41"
                                                            r="2.95"></circle>
                                                    <path className="fill-primary"
                                                    ...
                                                    <circle className="fill-primary" cx="25.86" cy="113.61"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="44.71" cy="113.61"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="63.57" cy="113.61"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="82.43" cy="113.61"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="101.29" cy="113.61"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="120.14" cy="113.61"
                                                            r="2.95"></circle>
                                                    <path className="fill-primary"
                                                    ...
                                                    <circle className="fill-primary" cx="25.86" cy="95.81"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="44.71" cy="95.81"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="63.57" cy="95.81"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="82.43" cy="95.81"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="101.29" cy="95.81"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="120.14" cy="95.81"
                                                            r="2.95"></circle>
                                                    <path className="fill-primary"
                                                    ...
                                                    <circle className="fill-primary" cx="25.86" cy="24.62"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="44.71" cy="24.62"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="63.57" cy="24.62"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="82.43" cy="24.62"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="101.29" cy="24.62"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="120.14" cy="24.62"
                                                            r="2.95"></circle>
                                                    <path className="fill-primary"
                                                    ...
                                                    <circle className="fill-primary" cx="25.86" cy="6.82"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="44.71" cy="6.82"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="63.57" cy="6.82"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="82.43" cy="6.82"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="101.29" cy="6.82"
                                                            r="2.95"></circle>
                                                    <circle className="fill-primary" cx="120.14" cy="6.82"
                                                            r="2.95"></circle>
                                                    <path className="fill-primary"
                                            ...
                                            <figure 
                                                className="position-absolute bottom-0 end-0 z-index-1 mb-n6 me-n6 d-none d-lg-block">
                                                <svg width="167" height="107" viewBox="0 0 167 107" fill="none" 
                                                     xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <img src={about14}
                                                 className="rounded position-relative zindex-2" alt="feature-img"/>
                                                ...
                                                <ul className="mb-0 align-items-center">
                                                    <li className="avatar avatar-xs me-1">
                                                        <img className="avatar-img rounded-circle "
                                                             src={avatar6} alt="avatar"/>
                                                    </li>
                                                    <li className="avatar avatar-xs">
                                                        <img className="avatar-img rounded-circle"
                                                             src={avatar5} alt="avatar"/>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <Card
                                                className="card-body position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                                ...
                                <Tab.Pane eventKey='collaboration' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">Collaboration</span>
                                            <h3 className="my-4">Streamlined teamwork and client engagement</h3>
                                            <p className="mb-5">Our collaboration feature empowers your agency with
                                                seamless
                                                teamwork and enhanced client engagement.</p>

                                            <Row className="g-4 mb-5">
                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsDiagram3 size={24} className="fa-xl text-primary me-3"/>Organized
                                                        your data</p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsBoxes size={24} className="fa-xl text-primary me-3"/>Embedded
                                                        Analytics</p>
                                                </Col>

                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsPeople size={24} className="fa-xl text-primary me-3"/>Work with
                                                        any team</p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsShieldCheck size={24} className="fa-xl text-primary me-3"/>Collaborate
                                                        securely</p>
                                                </Col>
                                            </Row>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="">Explore
                                                collaboration benefits<BsArrowRight className='bi'/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <Col md={8}
                                                 className="position-absolute top-50 start-0 translate-middle mt-xl-n9 d-none d-lg-block">
                                                <div className="bg-body rounded p-3">
                                                    <div
                                                        className="bg-light d-flex align-items-center rounded w-100 p-2 mb-3">

                                                        <div
                                                            className="icon-md bg-primary bg-opacity-10 rounded-circle text-primary flex-shrink-0 flex-centered">
                                                            <BsCheck className="fs-5"/></div>

                                                        <p className="heading-color mb-0 ms-2">Than continues its and
                                                            because can use.</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">Entire first decided the
                                                            so
                                                            must.</p>
                                                    </div>

                                                    <div
                                                        className="bg-light d-flex align-items-center rounded w-100 p-2">
                                            ...
                                            <div
                                                className="d-inline-block bg-white shadow rounded-4 position-absolute end-0 bottom-0 p-3 mb-n5 me-lg-n6 d-none d-sm-block">
                                                <img src={trustPilotImg} className="h-20px mb-2"
                                                     alt="Client-img"/>
                                                <div className="d-flex align-items-center">
                                                    <img src={trustStarImg}
                                                         className="h-30px" alt="rating-img"/>
                                            ...
                                            <figure className="position-absolute top-0 end-0 mt-n7 me-lg-n5">
                                                <svg width="120.4px" height="124.5px" viewBox="0 0 120.4 124.5">
                                                    ...
                                                    <path className="fill-primary"
                                                          d="M82.8,6.5c0,0,0,0.1,0,0.1C82.8,6.6,82.8,6.6,82.8,6.5C82.9,6.6,82.8,6.5,82.8,6.5z"></path>
                                                </svg>
                                            </figure>


                                            <img src={about17} className="rounded" alt="feature-img"/>
                                        </Col>
                                    </Row>
                                </Tab.Pane>
                            </Tab.Content>
