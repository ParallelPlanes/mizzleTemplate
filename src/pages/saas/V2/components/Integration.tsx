...
import {integrations} from "@/pages/saas/V2/data";
        ...
        <section>
            <Container>
                ...
                <div className="inner-container-small text-center mb-4 mb-sm-7">
                    ...
                    <p className="mb-0">Discover how effortless integration with our platform can supercharge your
                        agency's workflow. Achieve new levels of efficiency and collaboration with these simple
                        steps.</p>
                </div>
                    ...
                    <Row className="row-cols-4 row-cols-md-6 g-4 g-sm-5 g-md-6 justify-content-center">
                        {
                            integrations.map((tool, idx) => (
                                <Col className="text-center" key={idx}>
                                    <img src={tool.image} className="h-30px h-sm-50px h-md-60px" alt="Integration-img"/>
                                </Col>
                            ))
                        }
                    </Row>
