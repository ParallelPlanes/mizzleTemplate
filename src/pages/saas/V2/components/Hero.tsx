            ...
            <Container className="position-relative zindex-5 pt-5">
                <Row className="justify-content-xl-start justify-content-center flex-xl-nowrap">
                    <Col xl={6} className="ps-xl-5 mb-8 mb-xl-0">
                        ...
                        <p className="mt-4">Partnering with 500+ Fortune companies and mid-sized firms across
                            enterprises, uniquely customized and scalable workforce solutions.</p>

                        <div className="d-flex gap-3 gap-sm-4 flex-wrap mt-4 mt-md-5">
                            <Button size='lg' variant='dark' className="mb-0" type="button">Discover
                                features</Button>
                            <Link className="icon-link icon-link-hover heading-color text-primary-hover mb-0" to="">Contact
                                sales<BsArrowRight/> </Link>
                        </div>
                            ...
                            <Col sm={6}>
                                <figure className="mb-3">
                                    <svg width="154px" height="38.4px" viewBox="0 0 154 38.4">
                                        ...
                                        <path className="st0"
                                              d="M36,13.1H22.2L18,0l-4.3,13.1H0l11.1,8.1l-4.3,13L17.9,26L29,34.2l-4.2-13.1L36,13.1z"
                                              fill="#00B67A"/>
                                        <path className="st1" d="M25.8,24.1l-1-2.9l-6.8,5L25.8,24.1z" fill="#005128"/>
                                    </svg>
                                </figure>

                                <img src={trustpilotStar} className="h-20px mb-3"
                                     alt="Rating-img"/>
                                <p className="mb-0">Total score <span
                                    className="text-secondary text-opacity-25">|</span><span
                                    className="fw-bold heading-color"> 305 reviews</span></p>
                            </Col>

                            <Col sm={6}>
                                <img src={googleImg} className="mb-3 h-40px" alt="google icon"/>

                                <ul className="list-inline mb-2">
                                    <li className="list-inline-item me-0">
                                        <BsStarFill size={18} className="text-warning me-1"/></li>
                                    <li className="list-inline-item me-0">
                                        <BsStarFill size={18} className="text-warning me-1"/></li>
                                    <li className="list-inline-item me-0">
                                        <BsStarFill size={18} className="text-warning me-1"/></li>
                                    ...
                                    <li className="list-inline-item">
                                        <BsStarHalf size={18} className="text-warning"/></li>
                                </ul>
                                <p className="mb-0">Total score <span
                                    className="text-secondary text-opacity-25">|</span><span
                                    className="fw-bold heading-color"> 145 reviews</span></p>
                            </Col>
                        </Row>
                    </Col>

                    <Col xl={10} className="d-flex rotate-343 position-relative aos z-index-2" data-aos="zoom-in-up"
                        ...
                        <Parallax>
                            <figure className="position-absolute top-0 start-0 ms-9">
                                <svg className="opacity-2" width="148" height="140" viewBox="0 0 148 140"
                            ...
                            <img src={sassBackground} className="rounded-4 position-relative" alt=""/>


                            <div className="">
                                <img src={decoration1} data-depth="0.5"
