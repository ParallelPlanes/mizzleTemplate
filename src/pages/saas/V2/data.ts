...
import {ToolType, PricingType, TestimonialType, ClientType} from "@/pages/saas/V2/types";
...
export const testimonials: TestimonialType[] = [
    ...
    },
    {
        ...
        comment: "I can't say enough about the impact this platform has had on my agency. The automation tools, project management features, and seamless collaboration have transformed the way we work. ",
        user: {
            firstName: "Allen",
            lastName: "Smith",
