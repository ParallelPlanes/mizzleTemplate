import { Card, CardBody, CardFooter, CardTitle, Col, Container, Nav, NavItem, NavLink, OverlayTrigger, Popover, PopoverBody, Row } from "react-bootstrap"
import { blogs } from "@/pages/blog/Grid/data"
                ...
                <Col md={6} lg={4}>
                  <Card as={"article"} className="bg-dark p-4 overflow-hidden h-100" data-bs-theme="dark">
                    ...
                    <CardBody className="p-0">
                      ...
                      <CardTitle><Link to="">Collaborating to drive innovation in the Tech industry</Link></CardTitle>
                    </CardBody>
                ...
                <Col md={6} lg={4}>
                  <Card as={"article"} className="bg-primary p-4 overflow-hidden h-100">
                    <div className="position-absolute end-0 bottom-0 mb-n5 me-n7">
                      <img src="assets/images/elements/pattern.svg" className="opacity-4" />
                    </div>
                    <CardBody className="z-index-1 p-0">
                      <div className="d-flex justify-content-between mb-5">
                        <div className="badge bg-dark text-white small">Advertisements</div>
                        <OverlayTrigger trigger="click" placement="top" overlay={<Popover><PopoverBody>You're seeing this ad because your activity meets the intended audience of our site.</PopoverBody></Popover>}>
                        <a href="#!" className="mb-0 text-white small" tabIndex={0}>
