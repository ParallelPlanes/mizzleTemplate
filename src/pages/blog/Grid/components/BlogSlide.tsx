import type { BlogType } from "@/pages/blog/Grid/types"
...
const BlogSlide = ({ blog }: { blog: BlogType }) => {
  ...
  return (
    <Card className="overflow-hidden h-500px text-center rounded-0" style={{ backgroundImage: `url(${image})`, backgroundPosition: 'center left', backgroundSize: 'cover' }}>
