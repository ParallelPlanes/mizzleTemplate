        ...
        <Row className="g-4 g-sm-7">
          <Col lg={8}>
            <div className="d-flex position-relative z-index-9">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb breadcrumb-dots mb-1">
                  ...
                  <li className="breadcrumb-item active" aria-current="page">Blog single sidebar</li>
                </ol>
              </nav>
            </div>
            ...
            <div className="d-flex align-items-center flex-wrap mt-4">
              <Link to="" className="badge text-bg-dark mb-0">Lifestyle</Link>
            ...
            <Card as={"blockquote"} className="card-body bg-light overflow-hidden mt-5 p-sm-5">
              ...
              <span className="display-4 position-absolute top-0 start-0 opacity-1 mt-n3"><BsQuote className="bi" /></span>
            ...
            <Row className="mt-5">
              <Col md={6}>
                ...
                <p className="small mb-0">Recognizing and acknowledging the blessings in our lives, we invite a sense of abundance and contentment.</p>
              </Col>
            ...
            <div className="bg-light border rounded d-md-flex justify-content-between align-items-center text-center p-3 mt-5">
              ...
              <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                ...
                <label className="btn btn-outline-secondary icons-center gap-2 btn-sm mb-0" htmlFor="btnradio1"><FaRegThumbsUp className="me-1" /> Yes</label>
                <input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                <label className="btn btn-outline-secondary icons-center gap-2 btn-sm mb-0" htmlFor="btnradio2"> No <FaRegThumbsDown className="ms-1" /></label>
              </div>
            </div>
          </Col>
          <Sidebar />
