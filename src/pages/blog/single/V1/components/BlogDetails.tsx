      ...
      <Container>
        <Row className="g-4 g-lg-6">
          <Col lg={8} className="mx-auto text-center">
            <Link to="" className="badge text-bg-dark mb-4">Lifestyle</Link>
              ...
              <div className="d-flex justify-content-center align-items-center flex-wrap">
                <Dropdown>
                  <DropdownToggle as={"a"} href="" className="text-secondary text-primary-hover arrow-none icons-center" >
                    <BsShare className="me-2" />14
                  </DropdownToggle>
                  <DropdownMenu className="min-w-auto" aria-labelledby="cardFeedAction">
                    <li><DropdownItem href=""> <BsFacebook className="fa-fw me-2" />Facebook</DropdownItem></li>
                    <li><DropdownItem href=""> <BsInstagram className="fa-fw me-2" />Instagram</DropdownItem></li>
                    <li><DropdownItem href=""> <BsWhatsapp className="fa-fw me-2" />Whatsapp</DropdownItem></li>
                    <li><DropdownItem href=""> <FaRegPaste className="fa-fw me-2" />Copy link</DropdownItem></li>
                  </DropdownMenu>
                </Dropdown>
                <span className="text-secondary opacity-3 mx-3">|</span>
                <Link to="" className="text-secondary text-primary-hover mb-0 icons-center"><BsChat className="me-2" />5</Link>
                <span className="text-secondary opacity-3 mx-3">|</span>
          ...
          <Col lg={10} className="mx-auto">
            <Row className="g-4 g-lg-6">
              <Col sm={6}>
                <GlightBox image={blog4}>
                  <img src={blog4} className="rounded" alt="blog-img" />
                </GlightBox>
              </Col>
              <Col sm={6}>
                <GlightBox image={blog6}>
                  <img src={blog6} className="rounded" alt="blog-img" />
                </GlightBox>
              </Col>
            </Row>
          </Col>
          ...
          <Col lg={10} className="mx-auto text-center">
            <img src={blog3} className="img-fluid rounded" alt="blog-img" />
          </Col>
          <Col lg={8} className="mx-auto text-center">
            <h5 className="display-2 text-primary lh-0 mb-0"><BsQuote className="bi" /></h5>
            <q className="fs-4 heading-color">Fulfilled direction use continually set him propriety continued. Farther-related bed and passage comfort civilly. Concluded boy perpetual old supposing.</q>
            ...
            <div className="align-items-center">
              ...
              <ul className="list-inline mb-0 icons-center flex-wrap gap-1">
                {popularTags.map((tag, idx) => (
                  <li key={idx} className="list-inline-item"> <Link className="btn btn-outline-light btn-sm mb-lg-0" to="">{tag}</Link> </li>
                ))}
              </ul>
            </div>
            <div className="bg-light rounded d-md-flex justify-content-between align-items-center text-center p-3 mt-5">
              ...
              <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                ...
                <label className="btn btn-outline-secondary btn-sm mb-0 icons-center gap-1" htmlFor="btnradio1"><FaRegThumbsUp className="me-1" /> Yes</label>
                <input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                <label className="btn btn-outline-secondary btn-sm mb-0 icons-center gap-1" htmlFor="btnradio2"> No <FaRegThumbsDown className="ms-1" /></label>
              </div>
            </div>
          </Col>
        </Row>
